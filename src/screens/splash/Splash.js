  ...
  return (
    ...
    >
      <View style={styles.main}>
        ...
        >
          <Image
            source={require("../../assets/Images/SplashBottomLeft.png")}
            style={{ height: 330, width: 330 }}
          />
        </View>
        <View style={{ position: "absolute" }}>
          <Image
            source={require("../../assets/Images/SplashBottomRight.png")}
          />
        </View>
        {/* for logo */}
        <View style={{ alignSelf: "center" }}>
          ...
          >
            ...
            <Text style={{ fontSize: 48, fontWeight: "700", color: "#FF0F0F" }}>
              Started
            </Text>
          </View>
          ...
          <View>
            <Image
              source={require("../../assets/Images/FootballerImage.png")}
              style={{ resizeMode: "contain", height: 340, width: 400 }}
            />
          </View>
        </View>
      </View>
