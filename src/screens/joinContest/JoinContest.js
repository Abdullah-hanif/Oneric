        ...
        <ImageBackground source={require('../../assets/Images/BgImageLite.png')} style={{ flex: 1 }}>
            ...
            <ScrollView style={styles.main} >
                ...
                <View style={{ marginTop: 5, padding: 5, margin: 5, }}>
                    ...
                    {/* Cards render */}
                    <View style={{ padding: 5, margin: 5, borderRadius: 8, borderWidth: 1, width: '95%', height: 113, alignSelf: 'center', marginTop: '5%' }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
                            ...
                            <Text style={{ fontSize: 11, fontWeight: 400, right: 30 }}>Joining fee</Text>
                        </View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 0, alignItems: 'center' }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', left: 5 }}>
                                <Image source={require('../../assets/Iocns/InrLogo.png')} style={{ height: 21, width: 15, bottom: 5 }} />
                                <Text style={{ fontWeight: '700', fontSize: 28 }}>3.2 lakhs</Text>
                            </View>
                            <View style={{ right: 10, justifyContent: 'center', alignItems: 'center', width: 90, height: 30, backgroundColor: '#5AC73D', borderRadius: 26 }}>
                                <Text style={{ fontWeight: '700', fontSize: 16, color: '#FFFFFF' }}>₹50</Text>
                            </View>
                        </View >
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%', height: 28, backgroundColor: '#FFBE00', borderRadius: 25, position: 'absolute', top: '95%', alignSelf: 'center' }}>
                            <View style={{ left: 15, flexDirection: 'row' }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    <Image source={require('../../assets/Iocns/MedalIcon.png')} style={{ width: 8.5, height: 13 }} />
                                    <Text style={{ fontWeight: '400', fontSize: 12, color: '#ffff', left: 5 }}>₹50,444</Text>

                                </View>
                                <View style={{ flexDirection: 'row', left: 25, alignItems: 'center' }}>
                                    <Image source={require('../../assets/Iocns/TrophyIcon.png')} style={{ width: 8.5, height: 13 }} />
                                    <Text style={{ fontWeight: '400', fontSize: 12, color: '#ffff', left: 5 }}>60%</Text>

                                </View>
                            </View>
                            <View style={{ flexDirection: 'row', alignItems: 'center', right: 2 }}>
                                <Image source={require('../../assets/Iocns/loader.png')} style={{ right: 10, height: 19, width: 19 }} />
                                <View style={{ elevation: 5, width: 88, height: 23, backgroundColor: '#ffff', borderRadius: 25, alignItems: 'center', justifyContent: 'center' }}>
                                    <Text style={{ fontWeight: '600', fontSize: 10, color: 'black' }}>19/8,000 <Text style={{ fontWeight: '400', fontSize: 10 }}>spots</Text></Text>
                                </View>
                            </View>
                        </View>
                    </View>
                    <View style={{ padding: 5, margin: 5, borderRadius: 8, borderWidth: 1, width: '95%', height: 113, alignSelf: 'center', marginTop: '8%' }}>
                        <View style={{ position: 'absolute', justifyContent: 'flex-end', alignSelf: 'flex-end', }}>
                            <Image source={require('../../assets/Iocns/MegaSticker.png')} style={{ position: 'relative', width: 48, height: 48 }} />
                        </View>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingTop: 5 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 0, alignItems: 'center' }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center', left: 5 }}>
                                <Image source={require('../../assets/Iocns/InrLogo.png')} style={{ height: 21, width: 15, bottom: 5 }} />
                                <Text style={{ fontWeight: '700', fontSize: 28 }}>8.2 lakhs</Text>
                            </View>
                            <View style={{ right: 10, justifyContent: 'center', alignItems: 'center', width: 90, height: 30, backgroundColor: '#5AC73D', borderRadius: 26 }}>
                                <Text style={{ fontWeight: '700', fontSize: 16, color: '#FFFFFF' }}>₹70</Text>
                            </View>
                        </View >
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '100%', height: 28, backgroundColor: '#FFBE00', borderRadius: 25, position: 'absolute', top: '95%', alignSelf: 'center' }}>
                            <View style={{ left: 15, flexDirection: 'row' }}>
                    ...
                    <FullScreenModal isVisible={isModalVisible} onClose={toggleModal} content={
                        <View style={{ height: 342, width: 325, backgroundColor: '#FFFFFF', borderRadius: 10 }}>
                            ...
                            <View style={{ marginTop: '20%' }}>
                                ...
                                <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
                                    ...
                                    <Text style={{ fontWeight: "700", fontSize: 68, color: '#FF0F0F', bottom: 10 }}>₹</Text>
                                </View>
                            </View>
                            <TouchableOpacity onPress={() => navigation.navigate('UpCommingMatches')} style={{ zIndex: 9999, justifyContent: 'center', alignItems: 'center', alignSelf: 'center', backgroundColor: '#278C0C', width: 191, height: 47, borderRadius: 53 }}>
                                <Text style={{ color: '#FFFFFF', fontWeight: '400', fontSize: 14, letterSpacing: 5 }}>JOIN CONTEST</Text>
                            </TouchableOpacity>
                        </View>
                    } />
                </View>
