            ...
            <ScrollView style={styles.main} >
                ...
                <View style={{ marginTop: 5, padding: 5, margin: 5, }}>
                    <View style={{ flexDirection: 'column', left: 10 }}>
                        <Text style={{ fontWeight: '700', fontSize: 32 }}>Profile Setup</Text>
                        <Text style={{ fontWeight: '400', fontSize: 12 }}>Enter Your Details...</Text>
                    </View>
                    <View
                        style={{
                    ...
                    <View style={{ margin: 5, padding: 5 }}>
                        <Text style={{ fontWeight: '700', fontSize: 16 }}>Upload your Image <Text style={{ fontWeight: '700', fontSize: 16, color: '#FF0F0F' }}>or</Text><Text style={{ fontWeight: '400', fontSize: 16, color: '#999A9E' }}> select form our library</Text> </Text>
                        <View style={{ flexDirection: "row", justifyContent: 'space-around', marginTop: 20, alignSelf: 'flex-start', width: '100%', right: 15 }}>
                            <View style={{ width: 142, height: 142 }}>
                                <TouchableOpacity style={{ top: '40%', left: '90%', alignSelf: 'flex-end', flexDirection: 'row', position: 'absolute', zIndex: 9999, width: 33, height: 33, backgroundColor: '#5AC73D', borderRadius: 25, alignItems: 'center', justifyContent: 'center' }}>
                                    <Image source={require('../../assets/Iocns/ProfileSetupPlus.png')} style={{ width: 20, height: 20 }} />
                                </TouchableOpacity>
                                <Image source={require('../../assets/Images/ProfileSetupUser.png')} style={{ width: 142, height: 142 }} />
                            </View>
                            <View style={styles.container}>
                                <View style={styles.row}>
                                    <Image source={require('../../assets/Iocns/ProfileSetupOne.png')} style={styles.image} />
                                    <Image source={require('../../assets/Iocns/ProfileSetupTwo.png')} style={styles.image} />
                                    <Image source={require('../../assets/Iocns/ProfileSetupThree.png')} style={styles.image} />
                                </View>
                                <View style={styles.row}>
                                    <Image source={require('../../assets/Iocns/ProfileSetupFour.png')} style={styles.image} />
                                    <Image source={require('../../assets/Iocns/ProfileSetupFive.png')} style={styles.image} />
                                    <Image source={require('../../assets/Iocns/ProfileSetupSix.png')} style={styles.image} />
                                </View>
                                <View style={styles.row}>
                                    <Image source={require('../../assets/Iocns/ProfileSetupEleven.png')} style={styles.image} />
                                    <Image source={require('../../assets/Iocns/ProfileSetupEight.png')} style={styles.image} />
                                    <Image source={require('../../assets/Iocns/ProfileSetupNine.png')} style={styles.image} />
                                </View>
                        ...
                        <View style={{ marginTop: 20 }}>
                            ...
                            <View style={{ marginTop: 10, alignItems: 'center', justifyContent: 'space-between', flexDirection: 'row', width: '100%', height: 53, backgroundColor: '#1D1E22', borderRadius: 46 }}>
                                <TextInput placeholder='UserName' placeholderTextColor={'white'} style={{ height: '100%', width: '100%', paddingLeft: 15, fontWeight: '400', fontSize: 16, color: '#FFFFFF' }} />
                                <Image source={require('../../assets/Iocns/UserInput.png')} style={{ right: 40, width: 16, height: 16 }} />
                            </View>
                            <View style={{ marginTop: 20, elevation: 5 }}>
                                <Text style={{ fontWeight: '400', fontSize: 16, color: '#1D1E22' }}>Referral’s Mobile Number (Earn Cashback)</Text>
                                <View style={{ marginTop: 10, alignItems: 'center', width: '100%', height: 53, backgroundColor: '#1D1E22', borderRadius: 46 }}>
                                    <TextInput placeholder='Optional...' placeholderTextColor={'white'} style={{ height: '100%', width: '100%', paddingLeft: 15, fontWeight: '400', fontSize: 16, color: '#FFFFFF' }} />
                                </View>
                            </View>
                        </View>
