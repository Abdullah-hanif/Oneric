    ...
    >
      <View style={styles.main}>
        ...
        <View style={{ padding: 10, margin: 10, marginTop: 100 }}>
          ...
          />
          <Image
            source={require("../../assets/Images/OnericLogo.png")}
          ...
          <ScrollView style={{ padding: 5, margin: 5 }}>
            ...
            <View style={{ marginTop: 19 }}>
              ...
              <KeyboardAvoidingView>
                ...
                >
                  ...
                  />
                  <Image
                    source={require("../../assets/Iocns/MobileIcon.png")}
                  />
                </View>
              </KeyboardAvoidingView>
            </View>
            <View style={styles.switchContainer}>
              ...
              <Text style={styles.switchLabel}>
                I confirm that I am an Indian citizen of 18+ age and do not
                belong to the states of Assam, Odisha, Nagaland, Sikkim, Andhra
                Pradesh and Telangana and please make sure your entire number
                minimum 12.
              </Text>
            </View>
